...
import org.demo.navigation.tab.other.example2.CxboxMyExample3422Controller;
...
public class MyExample3423Meta extends FieldMetaBuilder<MyExample3423DTO> {
    ...
    public void buildRowDependentMeta(RowDependentFieldsMeta<MyExample3423DTO> fields, InnerBcDescription bcDescription,
        ...
        fields.setDrilldown(
                ...
                DrillDownType.INNER,
                "/screen/myexample3422/view/agreementInfo/" + CxboxMyExample3422Controller.myexample3423 + "/" + id
        );
    }
