...
@Service
@AllArgsConstructor
public class MyEntity3714TestDataLoadService {

	@Autowired
	MyEntity3714Repository repository;
	...
	public void load() {
		...
		repository.save(new Myexample3714().setFile(file.getData().getName()).setFileId(file.getData().getId()));
