...
public class MyEntity3860Dao extends AbstractAnySourceBaseDAO<MyEntity3860OutServiceDTO> implements AnySourceBaseDAO<MyEntity3860OutServiceDTO> {
    ...
    @Override
    public String getId(final MyEntity3860OutServiceDTO entity) {
        return entity.getId();
    }

    @Override
    public void setId(final String id, final MyEntity3860OutServiceDTO entity) {
        entity.setId(id);
    }
    ...
    // --8<-- [start:getList]
    @Override
    public Page<MyEntity3860OutServiceDTO> getList(final BusinessComponent bc, final QueryParameters queryParameters) {
        ...
        ResponseEntity<RestResponsePage<MyEntity3860OutServiceDTO>> responseEntity = restTemplate.exchange(
                urlTemplate,
                HttpMethod.GET,
                null,
