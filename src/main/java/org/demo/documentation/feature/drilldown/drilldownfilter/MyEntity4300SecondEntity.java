...
@SuperBuilder
@NoArgsConstructor
public class MyEntity4300SecondEntity extends BaseEntity {
	...
	@CollectionTable(name = "CUSTOM_FIELD_MULTIPLE_SELECT_MY_ENTITY_WITH_DRILLDOWN4300_S_E", joinColumns = @JoinColumn(name = "MY_ENTITY_WITH_DRILLDOWN4300_ID"))
	...
	@JoinTable(name = "LNK_MY_ENTITY_WITH_DRILLDOWN_4300_S_E__TO__MY_ENTITY_4300_MULTIVALUE",
			joinColumns = @JoinColumn(name = "LNK_MY_ENTITY_WITH_DRILLDOWN_4300_S_E_ID"),
	...
	@JoinTable(name = "LNK_MY_ENTITY_WITH_DRILLDOWN_4300_S_E__MY_ENTITY_4300_MULTIVALUE_HOVER",
			joinColumns = @JoinColumn(name = "MY_ENTITY_WITH_DRILLDOWN_4300_S_E_ID"),
	...
	@JoinColumn(name = "MY_ENTITY_WITH_DRILLDOWN4300_S_E__PICK_LIST")
	@ManyToOne
	private MyEntity4300PickList myEntity4300PickList;

	@JoinColumn(name = "MY_ENTITY_WITH_DRILLDOWN4300_SE__INLINE_PICK_LIST")
	@ManyToOne
