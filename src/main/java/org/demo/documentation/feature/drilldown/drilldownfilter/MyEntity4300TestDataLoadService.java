...
public class MyEntity4300TestDataLoadService {
	...
	@Autowired
	MyEntityWithDrilldown4300Repository repository;
	...
	public void load() {
		...
		dao.saveAll(mvh);
		buildEntity(1, pls, ipls, mvs, mvh);
		buildEntity(2, pls, ipls, mvs, mvh);
		buildEntity(3, pls, ipls, mvs, mvh);
		buildEntity(4, pls, ipls, mvs, mvh);
		buildEntity(5, pls, ipls, mvs, mvh);
		buildEntity(100);
	}
	...
	private MyEntityWithDrilldown4300 buildEntity(int idx, List<MyEntity4300PickList> pls, List<MyEntity4300InlinePickList> ipls,
		...
		MyEntityWithDrilldown4300 build = MyEntityWithDrilldown4300.builder()
				...
				.customFieldPercent((long) (idx * 20)) // 20, 40, 60…
				.customFieldNumber((long) (idx * 150)) // 150, 300, 450…
	...
	private MyEntity4300PostActionWithCustomBuilder buildEntity(int idx) {
