...
@Setter
@NoArgsConstructor
public class DateTimeWithSecondsColorConstDTO extends DataResponseDTO {

	@SearchParameter(name = "customField", provider = DateTimeValueProvider.class)
	private LocalDateTime customField;


	public DateTimeWithSecondsColorConstDTO(DateTimeWithSecondsColorConstEntity entity) {
