...
public class MyExample5061Meta extends FieldMetaBuilder<MyExample5061DTO> {
	...
	public void buildRowDependentMeta(RowDependentFieldsMeta<MyExample5061DTO> fields, InnerBcDescription bcDescription,
		...
		fields.setEnabled(MyExample5061DTO_.customField);
		fields.setEnabled(MyExample5061DTO_.startDateTime);
		fields.setEnabled(MyExample5061DTO_.endDateTime);
		fields.setRequired(MyExample5061DTO_.customField);
	}
