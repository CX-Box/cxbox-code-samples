...
public class MyExample4251Dao extends AbstractAnySourceBaseDAO<MyExample4251DTO> implements
		AnySourceBaseDAO<MyExample4251DTO> {

	private final MyEntity4240Repository repository;

	@Override
	public String getId(final MyExample4251DTO entity) {
		return entity.getId();
	}

	@Override
	public void setId(final String id, final MyExample4251DTO entity) {
		entity.setId(id);
	}

	@Override
	public MyExample4251DTO getByIdIgnoringFirstLevelCache(final BusinessComponent bc) {
	...
	@Override
	public Page<MyExample4251DTO> getList(final BusinessComponent bc, final QueryParameters queryParameters) {
		// --8<-- [start:getList]
		Pageable pageable = PageRequest.of(queryParameters.getPageNumber(), queryParameters.getPageSize());
		List<MyExample4251DTO> stats = getStats();
	...
	@Override
	public MyExample4251DTO update(BusinessComponent bc, MyExample4251DTO entity) {
		throw new IllegalStateException();
	}

	@Override
	public MyExample4251DTO create(final BusinessComponent bc, final MyExample4251DTO entity) {
		throw new IllegalStateException();
	}

	// --8<-- [start:getStats]
	@NonNull
	private List<MyExample4251DTO> getStats() {
		return repository.findAll().stream()
				...
				.map(e -> {
					...
					MyExample4251DTO dto = new MyExample4251DTO()
