...
public class MyExampleBc5046DAO extends AbstractAnySourceBaseDAO<MyExampleBc5046DTO> {
	...
	@Override
	public String getId(MyExampleBc5046DTO entity) {
		return entity.getId();
	}


	@Override
	public void setId(String id, MyExampleBc5046DTO entity) {
		entity.setId(id);
	}

	@Override
	public MyExampleBc5046DTO getByIdIgnoringFirstLevelCache(BusinessComponent bc) {
		return getStats().stream().filter(s -> Objects.equals(s.getId(), bc.getId())).findFirst().orElse(null);
	}

	@Override
	public Page<MyExampleBc5046DTO> getList(BusinessComponent bc, QueryParameters queryParameters) {
		return new PageImpl<>(getStats());
	}

	@Override
	public MyExampleBc5046DTO create(BusinessComponent bc, MyExampleBc5046DTO entity) {
		throw new IllegalStateException();
	}

	@Override
	public MyExampleBc5046DTO update(BusinessComponent bc, MyExampleBc5046DTO entity) {
		throw new IllegalStateException();
	}
	...
	private List<MyExampleBc5046DTO> getStats() {
		...
		myExampleBc5042.forEach(entity -> {
			...
			MyExampleBc5046DTO newRow = new MyExampleBc5046DTO()
