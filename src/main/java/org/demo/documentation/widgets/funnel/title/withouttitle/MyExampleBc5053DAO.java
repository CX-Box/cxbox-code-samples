...
public class MyExampleBc5053DAO extends AbstractAnySourceBaseDAO<MyExampleBc5053DTO> {
	...
	@Override
	public String getId(MyExampleBc5053DTO entity) {
		return entity.getId();
	}


	@Override
	public void setId(String id, MyExampleBc5053DTO entity) {
		entity.setId(id);
	}

	@Override
	public MyExampleBc5053DTO getByIdIgnoringFirstLevelCache(BusinessComponent bc) {
		return getStats().stream().filter(s -> Objects.equals(s.getId(), bc.getId())).findFirst().orElse(null);
	}

	@Override
	public Page<MyExampleBc5053DTO> getList(BusinessComponent bc, QueryParameters queryParameters) {
		return new PageImpl<>(getStats());
	}

	@Override
	public MyExampleBc5053DTO create(BusinessComponent bc, MyExampleBc5053DTO entity) {
		throw new IllegalStateException();
	}

	@Override
	public MyExampleBc5053DTO update(BusinessComponent bc, MyExampleBc5053DTO entity) {
		throw new IllegalStateException();
	}
	...
	private List<MyExampleBc5053DTO> getStats() {
		...
		myExampleBc5042.forEach(entity -> {
			...
			MyExampleBc5053DTO newRow = new MyExampleBc5053DTO()
