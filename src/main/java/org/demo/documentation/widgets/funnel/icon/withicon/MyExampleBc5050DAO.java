...
public class MyExampleBc5050DAO extends AbstractAnySourceBaseDAO<MyExampleBc5050DTO> {
	...
	@Override
	public String getId(MyExampleBc5050DTO entity) {
		return entity.getId();
	}


	@Override
	public void setId(String id, MyExampleBc5050DTO entity) {
		entity.setId(id);
	}

	@Override
	public MyExampleBc5050DTO getByIdIgnoringFirstLevelCache(BusinessComponent bc) {
		return getStats().stream().filter(s -> Objects.equals(s.getId(), bc.getId())).findFirst().orElse(null);
	}

	@Override
	public Page<MyExampleBc5050DTO> getList(BusinessComponent bc, QueryParameters queryParameters) {
		return new PageImpl<>(getStats());
	}

	@Override
	public MyExampleBc5050DTO create(BusinessComponent bc, MyExampleBc5050DTO entity) {
		throw new IllegalStateException();
	}

	@Override
	public MyExampleBc5050DTO update(BusinessComponent bc, MyExampleBc5050DTO entity) {
		throw new IllegalStateException();
	}
	...
	private List<MyExampleBc5050DTO> getStats() {
		...
		myExampleBc5042.forEach(entity -> {
			...
			MyExampleBc5050DTO newRow = new MyExampleBc5050DTO()
