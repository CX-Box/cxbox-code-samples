...
public class MyExampleBc5043DAO extends AbstractAnySourceBaseDAO<MyExampleBc5043DTO> {
	...
	@Override
	public String getId(MyExampleBc5043DTO entity) {
		return entity.getId();
	}


	@Override
	public void setId(String id, MyExampleBc5043DTO entity) {
		entity.setId(id);
	}

	@Override
	public MyExampleBc5043DTO getByIdIgnoringFirstLevelCache(BusinessComponent bc) {
		return getStats().stream().filter(s -> Objects.equals(s.getId(), bc.getId())).findFirst().orElse(null);
	}

	@Override
	public Page<MyExampleBc5043DTO> getList(BusinessComponent bc, QueryParameters queryParameters) {
		return new PageImpl<>(getStats());
	}

	@Override
	public MyExampleBc5043DTO create(BusinessComponent bc, MyExampleBc5043DTO entity) {
		throw new IllegalStateException();
	}

	@Override
	public MyExampleBc5043DTO update(BusinessComponent bc, MyExampleBc5043DTO entity) {
		throw new IllegalStateException();
	}
	...
	private List<MyExampleBc5043DTO> getStats() {
		...
		myExampleBc5042.forEach(entity -> {
			...
			MyExampleBc5043DTO newRow = new MyExampleBc5043DTO()
