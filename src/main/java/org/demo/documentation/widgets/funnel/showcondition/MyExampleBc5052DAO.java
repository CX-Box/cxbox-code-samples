...
public class MyExampleBc5052DAO extends AbstractAnySourceBaseDAO<MyExampleBc5052DTO> {
	...
	@Override
	public String getId(MyExampleBc5052DTO entity) {
		return entity.getId();
	}


	@Override
	public void setId(String id, MyExampleBc5052DTO entity) {
		entity.setId(id);
	}

	@Override
	public MyExampleBc5052DTO getByIdIgnoringFirstLevelCache(BusinessComponent bc) {
		return getStats().stream().filter(s -> Objects.equals(s.getId(), bc.getId())).findFirst().orElse(null);
	}

	@Override
	public Page<MyExampleBc5052DTO> getList(BusinessComponent bc, QueryParameters queryParameters) {
		return new PageImpl<>(getStats());
	}

	@Override
	public MyExampleBc5052DTO create(BusinessComponent bc, MyExampleBc5052DTO entity) {
		throw new IllegalStateException();
	}

	@Override
	public MyExampleBc5052DTO update(BusinessComponent bc, MyExampleBc5052DTO entity) {
		throw new IllegalStateException();
	}
	...
	private List<MyExampleBc5052DTO> getStats() {
		...
		myExampleBc5042.forEach(entity -> {
			...
			MyExampleBc5052DTO newRow = new MyExampleBc5052DTO()
