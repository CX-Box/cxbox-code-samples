...
public class MyExampleBc5044DAO extends AbstractAnySourceBaseDAO<MyExampleBc5044DTO> {
	...
	@Override
	public String getId(MyExampleBc5044DTO entity) {
		return entity.getId();
	}


	@Override
	public void setId(String id, MyExampleBc5044DTO entity) {
		entity.setId(id);
	}

	@Override
	public MyExampleBc5044DTO getByIdIgnoringFirstLevelCache(BusinessComponent bc) {
		return getStats().stream().filter(s -> Objects.equals(s.getId(), bc.getId())).findFirst().orElse(null);
	}

	@Override
	public Page<MyExampleBc5044DTO> getList(BusinessComponent bc, QueryParameters queryParameters) {
		return new PageImpl<>(getStats());
	}

	@Override
	public MyExampleBc5044DTO create(BusinessComponent bc, MyExampleBc5044DTO entity) {
		throw new IllegalStateException();
	}

	@Override
	public MyExampleBc5044DTO update(BusinessComponent bc, MyExampleBc5044DTO entity) {
		throw new IllegalStateException();
	}
	...
	private List<MyExampleBc5044DTO> getStats() {
		...
		myExampleBc5042.forEach(entity -> {
			...
			MyExampleBc5044DTO newRow = new MyExampleBc5044DTO()
