...
public class MyExampleBc5048DAO extends AbstractAnySourceBaseDAO<MyExampleBc5048DTO> {
	...
	@Override
	public String getId(MyExampleBc5048DTO entity) {
		return entity.getId();
	}


	@Override
	public void setId(String id, MyExampleBc5048DTO entity) {
		entity.setId(id);
	}

	@Override
	public MyExampleBc5048DTO getByIdIgnoringFirstLevelCache(BusinessComponent bc) {
		return getStats().stream().filter(s -> Objects.equals(s.getId(), bc.getId())).findFirst().orElse(null);
	}

	@Override
	public Page<MyExampleBc5048DTO> getList(BusinessComponent bc, QueryParameters queryParameters) {
		return new PageImpl<>(getStats());
	}

	@Override
	public MyExampleBc5048DTO create(BusinessComponent bc, MyExampleBc5048DTO entity) {
		throw new IllegalStateException();
	}

	@Override
	public MyExampleBc5048DTO update(BusinessComponent bc, MyExampleBc5048DTO entity) {
		throw new IllegalStateException();
	}
	...
	private List<MyExampleBc5048DTO> getStats() {
		...
		myExampleBc5042.forEach(entity -> {
			...
			MyExampleBc5048DTO newRow = new MyExampleBc5048DTO()
