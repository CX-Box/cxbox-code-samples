...
public class MyExampleBc5047DAO extends AbstractAnySourceBaseDAO<MyExampleBc5047DTO> {
	...
	@Override
	public String getId(MyExampleBc5047DTO entity) {
		return entity.getId();
	}


	@Override
	public void setId(String id, MyExampleBc5047DTO entity) {
		entity.setId(id);
	}

	@Override
	public MyExampleBc5047DTO getByIdIgnoringFirstLevelCache(BusinessComponent bc) {
		return getStats().stream().filter(s -> Objects.equals(s.getId(), bc.getId())).findFirst().orElse(null);
	}

	@Override
	public Page<MyExampleBc5047DTO> getList(BusinessComponent bc, QueryParameters queryParameters) {
		return new PageImpl<>(getStats());
	}

	@Override
	public MyExampleBc5047DTO create(BusinessComponent bc, MyExampleBc5047DTO entity) {
		throw new IllegalStateException();
	}

	@Override
	public MyExampleBc5047DTO update(BusinessComponent bc, MyExampleBc5047DTO entity) {
		throw new IllegalStateException();
	}
	...
	private List<MyExampleBc5047DTO> getStats() {
		...
		myExampleBc5042.forEach(entity -> {
			...
			MyExampleBc5047DTO newRow = new MyExampleBc5047DTO()
