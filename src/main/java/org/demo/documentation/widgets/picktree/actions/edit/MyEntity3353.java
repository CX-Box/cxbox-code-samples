...
@Setter
@NoArgsConstructor
public class MyEntity3353 extends BaseEntity {
	@Column
	private String customField;
	@JoinColumn(name = "CUSTOM_FIELD_PICK_LIST_ID")
	@ManyToOne
	private MyEntity3353Pick customFieldPickTreeEntity;
	@JoinColumn(name = "CUSTOM_FIELD_INLINE_PICK_LIST_ID")
	@ManyToOne
	private MyEntity3353Pick customFieldInlinePickTreeEntity;
}