...
@Setter
@NoArgsConstructor
public class MyExample3348DTO extends DataResponseDTO {
	...
	@SearchParameter(name = "customFieldInlinePicktreeEntity.customFieldPick")
	...
	public MyExample3348DTO(MyEntity3348 entity) {
