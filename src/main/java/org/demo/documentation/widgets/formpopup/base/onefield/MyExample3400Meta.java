...
public class MyExample3400Meta extends FieldMetaBuilder<MyExample3400DTO> {
	...
	public void buildRowDependentMeta(RowDependentFieldsMeta<MyExample3400DTO> fields, InnerBcDescription bcDescription,
		...
		fields.setEnabled(MyExample3400DTO_.customFieldInlinePicklistFAId);
		fields.setEnabled(MyExample3400DTO_.customFieldInlinePicklistFA);
	...
	public void buildIndependentMeta(FieldsMeta<MyExample3400DTO> fields, InnerBcDescription bcDescription, Long parentId) {
		fields.enableFilter(MyExample3400DTO_.customFieldInlinePicklistFA);
		...
		fields.setForceActive(MyExample3400DTO_.customField2);
		fields.setForceActive(MyExample3400DTO_.customFieldInlinePicklistFA);
	}
