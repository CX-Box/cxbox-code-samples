...
import org.demo.documentation.widgets.assoc.colortitle.enums.CustomFieldColorDictionaryEnum;
import org.demo.documentation.widgets.assoc.colortitle.enums.CustomFieldColorRadioEnum;
...
public class MyEntity3052MultiMultivalueMeta extends FieldMetaBuilder<MyEntity3052MultiMultivalueDTO> {
    ...
    public void buildRowDependentMeta(RowDependentFieldsMeta<MyEntity3052MultiMultivalueDTO> fields, InnerBcDescription bcDescription,
        ...
        fields.setEnabled(org.demo.documentation.widgets.assoc.colortitle.MyEntity3052MultiMultivalueDTO_.id);
        fields.setEnabled(org.demo.documentation.widgets.assoc.colortitle.MyEntity3052MultiMultivalueDTO_.customField);
    }
