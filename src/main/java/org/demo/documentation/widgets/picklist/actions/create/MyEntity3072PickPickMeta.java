...
public class MyEntity3072PickPickMeta extends FieldMetaBuilder<MyEntity3072PickPickDTO> {
    ...
    public void buildRowDependentMeta(RowDependentFieldsMeta<MyEntity3072PickPickDTO> fields, InnerBcDescription bcDescription,
        ...
        fields.setEnabled(org.demo.documentation.widgets.picklist.actions.create.MyEntity3072PickPickDTO_.id);
        fields.setEnabled(org.demo.documentation.widgets.picklist.actions.create.MyEntity3072PickPickDTO_.customFieldPick);
    }
