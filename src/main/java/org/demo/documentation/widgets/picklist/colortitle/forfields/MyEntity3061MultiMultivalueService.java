...
public class MyEntity3061MultiMultivalueService extends VersionAwareResponseService<MyEntity3061MultiMultivalueDTO, org.demo.documentation.widgets.picklist.colortitle.forfields.MyEntity3061Multi> {
    ...
    public MyEntity3061MultiMultivalueService() {
        super(MyEntity3061MultiMultivalueDTO.class, org.demo.documentation.widgets.picklist.colortitle.forfields.MyEntity3061Multi.class, null, MyEntity3061MultiMultivalueMeta.class);
    }
