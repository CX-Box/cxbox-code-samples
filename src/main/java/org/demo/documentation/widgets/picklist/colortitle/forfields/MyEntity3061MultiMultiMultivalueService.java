...
public class MyEntity3061MultiMultiMultivalueService extends VersionAwareResponseService<MyEntity3061MultiMultiMultivalueDTO, org.demo.documentation.widgets.picklist.colortitle.forfields.MyEntity3061MultiMulti> {
    ...
    public MyEntity3061MultiMultiMultivalueService() {
        super(MyEntity3061MultiMultiMultivalueDTO.class, org.demo.documentation.widgets.picklist.colortitle.forfields.MyEntity3061MultiMulti.class, null, MyEntity3061MultiMultiMultivalueMeta.class);
    }
