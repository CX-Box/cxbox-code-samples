...
@Repository
public interface MyEntity3329PickAssocRepository extends JpaRepository<MyEntity3329PicklistAssoc, Long>, JpaSpecificationExecutor<MyEntity3329PicklistAssoc> {
