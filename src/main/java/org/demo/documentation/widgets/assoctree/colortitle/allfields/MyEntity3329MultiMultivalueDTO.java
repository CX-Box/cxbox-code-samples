...
@Setter
@NoArgsConstructor
public class MyEntity3329MultiMultivalueDTO extends DataResponseDTO {
	...
	public MyEntity3329MultiMultivalueDTO(MyEntity3329Multi entity) {
		...
		this.customFieldColorMultivalueHover = entity.getCustomFieldColorMultivalueHoverList().stream().collect(MultivalueField.toMultivalueField(
				...
				MyEntity3329MultiAssoc::getCustomField
		));
		this.customFieldColorMultivalueHoverDisplayedKey = StringUtils.abbreviate(entity.getCustomFieldColorMultivalueHoverList().stream().map(MyEntity3329MultiAssoc::getCustomField
		...
		this.customFieldColorMultivalue = entity.getCustomFieldColorMultivalueList().stream().collect(MultivalueField.toMultivalueField(
				e -> String.valueOf(e.getId()),
				MyEntity3329MultiMultiAssoc::getCustomField
		));
		this.customFieldColorMultivalueDisplayedKey = StringUtils.abbreviate(entity.getCustomFieldColorMultivalueList().stream().map(MyEntity3329MultiMultiAssoc::getCustomField
		).collect(Collectors.joining(",")), 12);
