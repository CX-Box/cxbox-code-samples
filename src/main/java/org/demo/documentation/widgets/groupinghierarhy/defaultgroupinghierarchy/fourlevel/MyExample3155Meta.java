...
public class MyExample3155Meta extends FieldMetaBuilder<MyExample3155DTO> {
    ...
    public void buildRowDependentMeta(RowDependentFieldsMeta<MyExample3155DTO> fields, InnerBcDescription bcDescription,
        ...
        fields.setEnumValues(MyExample3155DTO_.customFieldDictionaryLevelThree, CustomFieldDictionaryLevelThreeEnum.values());
    ...
    public void buildIndependentMeta(FieldsMeta<MyExample3155DTO> fields, InnerBcDescription bcDescription, Long parentId) {
        fields.setEnumFilterValues(fields, MyExample3155DTO_.customFieldDictionaryLevelFour, CustomFieldDictionaryLevelFourEnum.values());
        fields.enableFilter(MyExample3155DTO_.customFieldDictionaryLevelFour);
        fields.setEnumFilterValues(fields, MyExample3155DTO_.customFieldDictionaryLevelThree, CustomFieldDictionaryLevelThreeEnum.values());
        fields.enableFilter(MyExample3155DTO_.customFieldDictionaryLevelThree);
        fields.setEnumFilterValues(fields, MyExample3155DTO_.customFieldDictionaryLevelTwo, CustomFieldDictionaryLevelTwoEnum.values());
