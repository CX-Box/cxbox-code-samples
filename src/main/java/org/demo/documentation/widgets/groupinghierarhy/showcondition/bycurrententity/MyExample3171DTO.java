...
public class MyExample3171DTO extends DataResponseDTO {
    ...
    public static final String TEXT2 = "Show condition - if customFieldDictionary  = HIGH widget show.";
    ...
    public MyExample3171DTO(MyEntity3171 entity) {
        ...
        this.customFieldShowCond = entity.getCustomFieldDictionary() == CustomFieldDictionaryEnum.HIGH ? "true" : "false";
