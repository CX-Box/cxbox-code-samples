...
import org.demo.documentation.widgets.info.base.allfields.forfields.MyEntity4222Pick;
import org.demo.documentation.widgets.info.base.allfields.forfields.MyEntity4222Pick2;
...
public class MyExample3001Service extends VersionAwareResponseService<MyExample3001DTO, MyEntity3001> {
    ...
    private final Class<MyExample3001Meta> meta = MyExample3001Meta.class;
    @Autowired
