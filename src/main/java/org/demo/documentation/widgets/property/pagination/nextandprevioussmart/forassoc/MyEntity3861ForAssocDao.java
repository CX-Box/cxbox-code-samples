...
public class MyEntity3861ForAssocDao extends AbstractAnySourceBaseDAO<MyEntity3861ForAssocOutServiceDTO> implements AnySourceBaseDAO<MyEntity3861ForAssocOutServiceDTO> {
    ...
    @Override
    public String getId(final MyEntity3861ForAssocOutServiceDTO entity) {
        return entity.getId();
    }

    @Override
    public void setId(final String id, final MyEntity3861ForAssocOutServiceDTO entity) {
        entity.setId(id);
    }
    ...
    @Override
    public MyEntity3861ForAssocOutServiceDTO getByIdIgnoringFirstLevelCache(final BusinessComponent bc) {
        return restTemplate.exchange(
                fromUriString(integrationConfig.getNextAndPreviousMicroservicesDataServerUrl() + "/{id}").build()
                        ...
                        .toUriString(),
                GET, null, MyEntity3861ForAssocOutServiceDTO.class
        ).getBody();
    }
    ...
    // --8<-- [start:getList]
    @Override
    public Page<MyEntity3861ForAssocOutServiceDTO> getList(final BusinessComponent bc, final QueryParameters queryParameters) {
        ...
        ResponseEntity<RestResponsePage<MyEntity3861ForAssocOutServiceDTO>> responseEntity = restTemplate.exchange(
                urlTemplate,
                HttpMethod.GET,
                null,
    ...
    @Override
    // --8<-- [start:create]
    public MyEntity3861ForAssocOutServiceDTO create(BusinessComponent bc, MyEntity3861ForAssocOutServiceDTO entity) {
        entity.setId(null);
        return restTemplate.exchange(
                fromUriString(integrationConfig.getNextAndPreviousMicroservicesDataServerUrl()).build().normalize().encode().toUriString(),
                POST, new HttpEntity<>(entity), MyEntity3861ForAssocOutServiceDTO.class
        ).getBody();
    }
    // --8<-- [end:create]
    ...
    @Override
    // --8<-- [start:update]
    public MyEntity3861ForAssocOutServiceDTO update(BusinessComponent bc, MyEntity3861ForAssocOutServiceDTO entity) {
        return restTemplate.exchange(
                fromUriString(integrationConfig.getNextAndPreviousMicroservicesDataServerUrl()).build().normalize().encode().toUriString(),
                PUT, new HttpEntity<>(entity), MyEntity3861ForAssocOutServiceDTO.class
        ).getBody();
    }
    // --8<-- [end:update]
