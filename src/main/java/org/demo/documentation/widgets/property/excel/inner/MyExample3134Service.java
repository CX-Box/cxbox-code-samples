...
public class MyExample3134Service extends VersionAwareResponseService<MyExample3134DTO, MyEntity3134> {
	...
	protected ActionResultDTO<MyExample3134DTO> doUpdateEntity(MyEntity3134 entity, MyExample3134DTO data, BusinessComponent bc) {
		if (data.isFieldChanged(MyExample3134DTO_.customFieldSuggectionPickListId)) {
			entity.setCustomFieldSuggectionPickListEntity(data.getCustomFieldSuggectionPickListId() != null
					? entityManager.getReference(MyEntity3134SuggectionPick.class, data.getCustomFieldSuggectionPickListId())
					: null);
		}
