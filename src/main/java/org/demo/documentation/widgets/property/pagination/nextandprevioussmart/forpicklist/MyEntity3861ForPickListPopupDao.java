...
public class MyEntity3861ForPickListPopupDao extends AbstractAnySourceBaseDAO<MyEntity3861ForPickListpopupOutServiceDTO> implements AnySourceBaseDAO<MyEntity3861ForPickListpopupOutServiceDTO> {
	...
	@Override
	public String getId(final MyEntity3861ForPickListpopupOutServiceDTO entity) {
		return entity.getId();
	}

	@Override
	public void setId(final String id, final MyEntity3861ForPickListpopupOutServiceDTO entity) {
		entity.setId(id);
	}
	...
	@Override
	public MyEntity3861ForPickListpopupOutServiceDTO getByIdIgnoringFirstLevelCache(final BusinessComponent bc) {
		return restTemplate.exchange(
				fromUriString(integrationConfig.getNextAndPreviousMicroservicesDataServerUrl() + "/{id}").build()
						...
						.toUriString(),
				GET, null, MyEntity3861ForPickListpopupOutServiceDTO.class
		).getBody();
	}
	...
	// --8<-- [start:getList]
	@Override
	public Page<MyEntity3861ForPickListpopupOutServiceDTO> getList(final BusinessComponent bc, final QueryParameters queryParameters) {
		...
		ResponseEntity<RestResponsePage<MyEntity3861ForPickListpopupOutServiceDTO>> responseEntity = restTemplate.exchange(
				urlTemplate,
				HttpMethod.GET,
				null,
	...
	@Override
	// --8<-- [start:create]
	public MyEntity3861ForPickListpopupOutServiceDTO create(BusinessComponent bc, MyEntity3861ForPickListpopupOutServiceDTO entity) {
		entity.setId(null);
		return restTemplate.exchange(
				fromUriString(integrationConfig.getNextAndPreviousMicroservicesDataServerUrl()).build().normalize().encode().toUriString(),
				POST, new HttpEntity<>(entity), MyEntity3861ForPickListpopupOutServiceDTO.class
		).getBody();
	}
	// --8<-- [end:create]
	...
	@Override
	// --8<-- [start:update]
	public MyEntity3861ForPickListpopupOutServiceDTO update(BusinessComponent bc, MyEntity3861ForPickListpopupOutServiceDTO entity) {
		return restTemplate.exchange(
				fromUriString(integrationConfig.getNextAndPreviousMicroservicesDataServerUrl()).build().normalize().encode().toUriString(),
				PUT, new HttpEntity<>(entity), MyEntity3861ForPickListpopupOutServiceDTO.class
		).getBody();
	}
	// --8<-- [end:update]
