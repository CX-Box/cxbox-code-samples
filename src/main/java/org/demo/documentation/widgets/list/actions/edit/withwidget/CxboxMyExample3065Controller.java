...
public enum CxboxMyExample3065Controller implements EnumBcIdentifier {
    ...
    myexample3065(MyExample3065Service.class), myEntity102Pick(myexample3065, MyEntity102PickService.class), myEntity10Pick(myexample3065, MyEntity10PickService.class), myEntity101Pick(myEntity10Pick, MyEntity101PickService.class), applicationEntityPick0(myexample3065, ApplicationEntityPick0Service.class), applicationEntityPick(myexample3065, ApplicationEntityPickService.class), dateBasicPick(myexample3065, DateBasicPickService.class);
