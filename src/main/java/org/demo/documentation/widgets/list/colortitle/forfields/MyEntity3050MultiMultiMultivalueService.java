...
public class MyEntity3050MultiMultiMultivalueService extends VersionAwareResponseService<MyEntity3050MultiMultiMultivalueDTO, org.demo.documentation.widgets.list.colortitle.forfields.MyEntity3050MultiMulti> {
    ...
    public MyEntity3050MultiMultiMultivalueService() {
        super(MyEntity3050MultiMultiMultivalueDTO.class, org.demo.documentation.widgets.list.colortitle.forfields.MyEntity3050MultiMulti.class, null, MyEntity3050MultiMultiMultivalueMeta.class);
    }
