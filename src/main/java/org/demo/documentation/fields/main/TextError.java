...
public class TextError {
	...
	public static final String MORE_CURRENT_TIME = "The field cannot be more than the current time";
	...
	public static final String LESS_SIZE = "he file should not exceed 9 KB";
}