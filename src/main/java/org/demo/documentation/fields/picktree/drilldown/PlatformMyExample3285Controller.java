...
public enum PlatformMyExample3285Controller implements EnumBcIdentifier {
	...
	myEntity3285PickTreePopup(myExampleBc3285, MyEntity3285PickPickTreeService.class);
	// --8<-- [end:bc]


	public static final EnumBcIdentifier.Holder<PlatformMyExample3285Controller> Holder = new Holder<>(
