...
import org.demo.documentation.fields.suggestion.required.MyEntity3087OutServiceDTO;
...
public class MyEntity3087Dao extends AbstractAnySourceBaseDAO<MyEntity3087OutServiceDTO> implements AnySourceBaseDAO<MyEntity3087OutServiceDTO> {
    ...
    @Override
    public String getId(final MyEntity3087OutServiceDTO entity) {
        return entity.getId();
    }

    @Override
    public void setId(final String id, final MyEntity3087OutServiceDTO entity) {
        entity.setId(id);
    }
    ...
    @Override
    public MyEntity3087OutServiceDTO getByIdIgnoringFirstLevelCache(final BusinessComponent bc) {
        return restTemplate.exchange(
                fromUriString(integrationConfig.getSuggestionMicroservicesDataServerUrl() + "/{id}").build()
                        ...
                        .toUriString(),
                GET, null, MyEntity3087OutServiceDTO.class
        ).getBody();
    }
    ...
    // --8<-- [start:getList]
    @Override
    public Page<MyEntity3087OutServiceDTO> getList(final BusinessComponent bc, final QueryParameters queryParameters) {
        ...
        ResponseEntity<RestResponsePage<MyEntity3087OutServiceDTO>> responseEntity = restTemplate.exchange(
                urlTemplate,
                HttpMethod.GET,
                null,
    ...
    @Override
    // --8<-- [start:create]
    public MyEntity3087OutServiceDTO create(BusinessComponent bc, MyEntity3087OutServiceDTO entity) {
        return restTemplate.exchange(
                fromUriString(integrationConfig.getSuggestionMicroservicesDataServerUrl()).build().normalize().encode().toUriString(),
                POST, new HttpEntity<>(entity), MyEntity3087OutServiceDTO.class
        ).getBody();
    }
    // --8<-- [end:create]
    ...
    @Override
    // --8<-- [start:update]
    public MyEntity3087OutServiceDTO update(BusinessComponent bc, MyEntity3087OutServiceDTO entity) {
        return restTemplate.exchange(
                fromUriString(integrationConfig.getSuggestionMicroservicesDataServerUrl()).build().normalize().encode().toUriString(),
                PUT, new HttpEntity<>(entity), MyEntity3087OutServiceDTO.class
        ).getBody();
    }
    // --8<-- [end:update]
