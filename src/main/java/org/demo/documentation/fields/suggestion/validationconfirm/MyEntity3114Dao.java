...
public class MyEntity3114Dao extends AbstractAnySourceBaseDAO<MyEntity3114OutServiceDTO> implements AnySourceBaseDAO<MyEntity3114OutServiceDTO> {
    ...
    @Override
    public String getId(final MyEntity3114OutServiceDTO entity) {
        return entity.getId();
    }

    @Override
    public void setId(final String id, final MyEntity3114OutServiceDTO entity) {
        entity.setId(id);
    }
    ...
    @Override
    public MyEntity3114OutServiceDTO getByIdIgnoringFirstLevelCache(final BusinessComponent bc) {
        return restTemplate.exchange(
                fromUriString(integrationConfig.getSuggestionMicroservicesDataServerUrl() + "/{id}").build()
                        ...
                        .toUriString(),
                GET, null, MyEntity3114OutServiceDTO.class
        ).getBody();
    }
    ...
    // --8<-- [start:getList]
    @Override
    public Page<MyEntity3114OutServiceDTO> getList(final BusinessComponent bc, final QueryParameters queryParameters) {
        ...
        ResponseEntity<RestResponsePage<MyEntity3114OutServiceDTO>> responseEntity = restTemplate.exchange(
                urlTemplate,
                HttpMethod.GET,
                null,
    ...
    @Override
    // --8<-- [start:create]
    public MyEntity3114OutServiceDTO create(BusinessComponent bc, MyEntity3114OutServiceDTO entity) {
        return restTemplate.exchange(
                fromUriString(integrationConfig.getSuggestionMicroservicesDataServerUrl()).build().normalize().encode().toUriString(),
                POST, new HttpEntity<>(entity), MyEntity3114OutServiceDTO.class
        ).getBody();
    }
    // --8<-- [end:create]
    ...
    @Override
    // --8<-- [start:update]
    public MyEntity3114OutServiceDTO update(BusinessComponent bc, MyEntity3114OutServiceDTO entity) {
        return restTemplate.exchange(
                fromUriString(integrationConfig.getSuggestionMicroservicesDataServerUrl()).build().normalize().encode().toUriString(),
                PUT, new HttpEntity<>(entity), MyEntity3114OutServiceDTO.class
        ).getBody();
    }
    // --8<-- [end:update]
