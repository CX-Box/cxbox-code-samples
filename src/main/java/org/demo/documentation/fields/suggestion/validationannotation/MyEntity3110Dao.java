...
public class MyEntity3110Dao extends AbstractAnySourceBaseDAO<MyEntity3110OutServiceDTO> implements AnySourceBaseDAO<MyEntity3110OutServiceDTO> {
    ...
    @Override
    public String getId(final MyEntity3110OutServiceDTO entity) {
        return entity.getId();
    }

    @Override
    public void setId(final String id, final MyEntity3110OutServiceDTO entity) {
        entity.setId(id);
    }
    ...
    @Override
    public MyEntity3110OutServiceDTO getByIdIgnoringFirstLevelCache(final BusinessComponent bc) {
        return restTemplate.exchange(
                fromUriString(integrationConfig.getSuggestionMicroservicesDataServerUrl() + "/{id}").build()
                        ...
                        .toUriString(),
                GET, null, MyEntity3110OutServiceDTO.class
        ).getBody();
    }
    ...
    // --8<-- [start:getList]
    @Override
    public Page<MyEntity3110OutServiceDTO> getList(final BusinessComponent bc, final QueryParameters queryParameters) {
        ...
        ResponseEntity<RestResponsePage<MyEntity3110OutServiceDTO>> responseEntity = restTemplate.exchange(
                urlTemplate,
                HttpMethod.GET,
                null,
    ...
    @Override
    // --8<-- [start:create]
    public MyEntity3110OutServiceDTO create(BusinessComponent bc, MyEntity3110OutServiceDTO entity) {
        return restTemplate.exchange(
                fromUriString(integrationConfig.getSuggestionMicroservicesDataServerUrl()).build().normalize().encode().toUriString(),
                POST, new HttpEntity<>(entity), MyEntity3110OutServiceDTO.class
        ).getBody();
    }
    // --8<-- [end:create]
    ...
    @Override
    // --8<-- [start:update]
    public MyEntity3110OutServiceDTO update(BusinessComponent bc, MyEntity3110OutServiceDTO entity) {
        return restTemplate.exchange(
                fromUriString(integrationConfig.getSuggestionMicroservicesDataServerUrl()).build().normalize().encode().toUriString(),
                PUT, new HttpEntity<>(entity), MyEntity3110OutServiceDTO.class
        ).getBody();
    }
    // --8<-- [end:update]
