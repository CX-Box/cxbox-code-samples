...
import org.demo.documentation.fields.text.validationbusinessex.MyExample49DTO_;
...
public class MyExample3113Service extends VersionAwareResponseService<MyExample3113DTO, MyEntity3113> {
    ...
    public MyExample3113Service(MyEntity3113Repository repository) {
        super(MyExample3113DTO.class, MyEntity3113.class, null, MyExample3113Meta.class);
