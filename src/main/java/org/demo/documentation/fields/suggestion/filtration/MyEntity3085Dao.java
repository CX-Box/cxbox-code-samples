...
import org.demo.documentation.fields.suggestion.filtration.MyEntity3085OutServiceDTO;
...
public class MyEntity3085Dao extends AbstractAnySourceBaseDAO<MyEntity3085OutServiceDTO> implements AnySourceBaseDAO<MyEntity3085OutServiceDTO> {
    ...
    @Override
    public String getId(final MyEntity3085OutServiceDTO entity) {
        return entity.getId();
    }

    @Override
    public void setId(final String id, final MyEntity3085OutServiceDTO entity) {
        entity.setId(id);
    }
    ...
    @Override
    public MyEntity3085OutServiceDTO getByIdIgnoringFirstLevelCache(final BusinessComponent bc) {
        return restTemplate.exchange(
                fromUriString(integrationConfig.getSuggestionMicroservicesDataServerUrl() + "/{id}").build()
                        ...
                        .toUriString(),
                GET, null, MyEntity3085OutServiceDTO.class
        ).getBody();
    }
    ...
    // --8<-- [start:getList]
    @Override
    public Page<MyEntity3085OutServiceDTO> getList(final BusinessComponent bc, final QueryParameters queryParameters) {
        ...
        ResponseEntity<RestResponsePage<MyEntity3085OutServiceDTO>> responseEntity = restTemplate.exchange(
                urlTemplate,
                HttpMethod.GET,
                null,
    ...
    @Override
    // --8<-- [start:create]
    public MyEntity3085OutServiceDTO create(BusinessComponent bc, MyEntity3085OutServiceDTO entity) {
        return restTemplate.exchange(
                fromUriString(integrationConfig.getSuggestionMicroservicesDataServerUrl()).build().normalize().encode().toUriString(),
                POST, new HttpEntity<>(entity), MyEntity3085OutServiceDTO.class
        ).getBody();
    }
    // --8<-- [end:create]
    ...
    @Override
    // --8<-- [start:update]
    public MyEntity3085OutServiceDTO update(BusinessComponent bc, MyEntity3085OutServiceDTO entity) {
        return restTemplate.exchange(
                fromUriString(integrationConfig.getSuggestionMicroservicesDataServerUrl()).build().normalize().encode().toUriString(),
                PUT, new HttpEntity<>(entity), MyEntity3085OutServiceDTO.class
        ).getBody();
    }
    // --8<-- [end:update]
