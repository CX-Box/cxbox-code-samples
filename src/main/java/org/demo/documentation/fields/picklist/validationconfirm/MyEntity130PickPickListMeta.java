...
public class MyEntity130PickPickListMeta extends FieldMetaBuilder<MyEntity130PickDTO> {
	...
	public void buildRowDependentMeta(RowDependentFieldsMeta<MyEntity130PickDTO> fields, InnerBcDescription bcDescription,
		...
		fields.setEnabled(org.demo.documentation.fields.picklist.validationconfirm.MyEntity130PickDTO_.id);
		fields.setEnabled(org.demo.documentation.fields.picklist.validationconfirm.MyEntity130PickDTO_.customField);
	}
	...
	public void buildIndependentMeta(FieldsMeta<MyEntity130PickDTO> fields, InnerBcDescription bcDescription,
									 Long parentId) {
		fields.enableFilter(MyEntity130PickDTO_.customField);
		fields.enableSort(MyEntity130PickDTO_.customField);
		fields.enableSort(MyEntity130PickDTO_.id);
