...
public class MyEntity4001Dao extends AbstractAnySourceBaseDAO<MyEntity4001OutServiceDTO> implements AnySourceBaseDAO<MyEntity4001OutServiceDTO> {
	...
	public Page<MyEntity4001OutServiceDTO> getList(final BusinessComponent bc, final QueryParameters queryParameters) {
		...
		String urlTemplate = UriComponentsBuilder.fromUriString(integrationConfig.getGetStartedMicroservicesDataServerUrl())
