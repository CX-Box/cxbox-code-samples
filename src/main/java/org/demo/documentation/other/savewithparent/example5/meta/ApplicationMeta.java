...
import org.demo.documentation.fields.input.drilldown.CxboxInputDrilldownController;
import org.demo.documentation.fields.input.drilldown.InputDrilldownDTO_;
...
public class ApplicationMeta extends FieldMetaBuilder<ApplicationEntityDTO> {
	...
	@Override
	public void buildRowDependentMeta(RowDependentFieldsMeta<ApplicationEntityDTO> fields, InnerBcDescription bcDescription, Long id, Long parentId) {
		fields.setEnabled(ApplicationEntityDTO_.name,
				ApplicationEntityDTO_.status);
		fields.setRequired(ApplicationEntityDTO_.name);
		fields.setEnabled(ApplicationEntityDTO_.createdDate);
	...
	@Override
	public void buildIndependentMeta(FieldsMeta<ApplicationEntityDTO> fields, InnerBcDescription bcDescription, Long parentId) {
		...
		fields.setForceActive(ApplicationEntityDTO_.name,
