...
import org.demo.documentation.other.savewithparent.example5.entity.ApplicationEntity_;
...
@Service
public class MyExample5555ApplicationService extends VersionAwareResponseService<ApplicationEntityDTO, ApplicationEntity> {
	...
	@Override
	protected ActionResultDTO<ApplicationEntityDTO> doUpdateEntity(ApplicationEntity entity, ApplicationEntityDTO data, BusinessComponent bc) {
	...
	@Override
	protected Specification<ApplicationEntity> getParentSpecification(BusinessComponent bc) {
		return (root, cq, cb) -> cb.and(
				super.getParentSpecification(bc).toPredicate(root, cq, cb),
				cb.equal(root.get(ApplicationEntity_.id), bc.getParentIdAsLong())
		);
	}
