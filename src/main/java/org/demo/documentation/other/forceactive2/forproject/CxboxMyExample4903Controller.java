...
public enum CxboxMyExample4903Controller implements EnumBcIdentifier {
    ...
    myexample4903(MyExample4903Service.class), myEntity4903OCPPickPick(myexample4903, MyEntity4903OCPPickPickService.class), myEntity4903PickPick(myexample4903, MyEntity4903PickPickService.class);
