...
public class WmaToMp3 implements Converter {

	public static ConverterIdentifier WMA_TO_MP3 = ConverterIdentifier.of(FileConverterServiceExt.WMA, FileConverterServiceExt.MP3);
