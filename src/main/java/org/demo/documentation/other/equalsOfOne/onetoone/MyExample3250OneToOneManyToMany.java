...
@Setter
@Entity
@Table(name = "MY_EXAMPLE_3250_ONE_TO_ONE_MANY_TO_MANY")
@NoArgsConstructor
@SuperBuilder
public class MyExample3250OneToOneManyToMany extends BaseEntity {

	@ManyToMany
	private Set<MyExample3250OneToOne> myExample3250OneToOnes;

	@Enumerated(EnumType.STRING)
	private MyExample3250Dictionary dictionary;

	@ElementCollection(targetClass = MyExample3250ElementCollectionData.class)
	@CollectionTable(name = "MY_EXAMPLE3250_ELEMENT_COLLECTION_DATA_ENTITY", joinColumns = @JoinColumn(name = "MY_EXAMPLE_3250_ONE_TO_ONE_MANY_TO_MANY_ID"))
	...
	@JoinTable(
			...
			joinColumns = @JoinColumn(name = "MY_EXAMPLE3250_ONE_TO_ONE_MANY_TO_MANY_ID"),
