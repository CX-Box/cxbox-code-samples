...
@Setter
@Entity
@Table(name = "MY_EXAMPLE3250_ONE_TO_ONE_ONE_TO_MANY")
@SuperBuilder
@NoArgsConstructor
public class MyExample3250OneToOneOneToMany extends BaseEntity {

	@ManyToOne
	@JoinColumn(name = "MY_EXAMPLE_3250_ONE_TO_ONE_ID")
	...
	@CollectionTable(name = "MY_EXAMPLE3250_ELEMENT_COLLECTION_DATA_ENTITY", joinColumns = @JoinColumn(name = "MY_EXAMPLE3250_ONE_TO_ONE_ONE_TO_MANY_ID"))
	...
	@JoinTable(
			...
			joinColumns = @JoinColumn(name = "MY_EXAMPLE3250_ONE_TO_ONE_ONE_TO_MANY_ID"),
