...
//	}
//
//	public SelenideElement findElementByTitle(String title) {
//		return Allure.step("Validation InfoWidget by heading (Title) " + title, step -> {
//			logTime(step);
//			step.parameter("Widget title", title);
//			return findWidgetByTypesAndTitle(WidgetType.INFO, title);
//		});
//
//	}
//
...
//					.shouldBe(Condition.exist, waitingForTests.getTimeout());
...
//				+ "']")
//				.shouldBe(Condition.enabled, waitingForTests.getTimeout());
//	}
//
//	/**
