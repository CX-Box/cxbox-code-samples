...
@Slf4j
public class CxboxAppReadyCheck extends AppReadyCheck {
	...
	@Override
	@SneakyThrows
	public void waitAppLoginPageReady(@NonNull URI uri, @NonNull Duration totalWait, @NonNull Duration retryPeriod) {
	 ...
	 */
	@SneakyThrows
	public boolean awaitIsTrue(Duration totalWait, Duration retryPeriod, String target,
