...
public class DateTimeFilter<
		...
		SELF extends DateTimeFilter<WIDGET, ROWS, ROW, PARENT, SELF>
		> extends AbstractFilter<WIDGET, ROWS, ROW, LocalDateTime, PARENT, SELF> {


	public DateTimeFilter(WIDGET widget, PARENT parent, LocalDateTime date) {
	...
	public SELF filter(LocalDateTime date) {
		...
		getParent().element().$(DATA_TEST_WIDGET_LIST_HEADER_COLUM_FILTER)
				.click();
		Calendar.setDateField(Calendar.formattedDateTime(date));
