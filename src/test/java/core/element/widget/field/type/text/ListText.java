...
public class ListText
		<
				...
				>
		extends Text<W, ListText<W, RR, R>> implements ParentRow<R> {

	private final R row;

	public ListText(W widget, String title, R row) {
		super(widget, title);
		this.row = row;
	}
	...
	public String valueTag() {
		if (row instanceof PlatformListRowInline pr && !pr.getIsEdit()) {
