...
@Tag("Samples")
@Tag("List")
@Feature(InputOnListTest.ARTICLE)
public class InputOnListTest extends BaseTestForSamples {

	static final String ARTICLE = "widget/fields/field/input";
...
//		assertThat(list.checkSorting("brand")).isFalse();
	...
	@Test
	void position() {
		assertTrue(Position.checkPosition(302, 94, PlatformApp.screen("Input basic").secondLevelView("List").listInline("List").element()));
	}
}
