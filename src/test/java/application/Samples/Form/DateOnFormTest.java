...
@Feature(DateOnFormTest.ARTICLE)
...
public class DateOnFormTest extends BaseTestForSamples {
	...
	@Test
	void position() {
		assertTrue(Position.checkPosition(302, 94, PlatformApp.screen("Date basic").secondLevelView("Form").form("Form title").element()));
	}
}
