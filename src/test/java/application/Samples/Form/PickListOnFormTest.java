...
@Feature(PickListOnFormTest.ARTICLE)
public class PickListOnFormTest extends BaseTestForSamples {
	...
	void placeholder() {
		var form = PlatformApp.screen("Picklist placeholder")
				.secondLevelView("Form")
				.form("Form title");
		form.pickList("Custom Field")
...
//        assertThat(customField.getValue()).isEqualTo("New data");
	...
	@Test
	void position() {
		assertTrue(Position.checkPosition(302, 95, PlatformApp.screen("Picklist basic").secondLevelView("Form").form("Form title").element()));
	}
/*
    @Test
    @Severity(MINOR)
