...
/** The CardList widget with a show condition by the parent entity. */
@DisplayName("CardList. Show condition")
@Epic("Samples")
@Feature(CardListShowConditionTest.ARTICLE)
@Tag("Samples")
@Tag("CardList")
public class CardListShowConditionTest extends BaseTestForSamples {
	...
	void showConditionByParentEntity() {
		var view = PlatformApp.screen("CardList show condition").view();
		var parent = view.formByName("MyExample5303Parent");
		var cards = view.cardListByName("MyExample5313CardList");
